 ...
 // Thread identifiers
    ...
    for (int t=0; t<numTiles; t++) {
        ...
        for (int w=0; w<WPT; w++) {
            ...
            //Esub[row][col+w*RTS] = matrixA[globalRow*pDim+(tiledCol + w*RTS)];
            //Fsub[row][col+w*RTS] = matrixB[(globalCol + w*RTS) + tiledRow*nDim];
            //Gsub[row][col+w*RTS] = matrixA[globalRow*pDim+(tiledCol + w*RTS)];
            //Hsub[row][col+w*RTS] = matrixB[(globalCol + w*RTS) + tiledRow*nDim];
        }
